			...
			<main>
				<section id='welcome' className='welcome'>
					...
					<Row className='header my-3 p-3 mb-0 pb-0'>
						...
						<Col className='flex social-icons'>
							<a
								href="https://twitter.com/KRBYmusic"
								target='_blank'
								className='circle flex button'>
								<img src={twitter} alt="Twitter" />
							</a>
							<a
								href="https://www.instagram.com/krbymusic/"
								target='_blank'
								className='circle flex button'>
					...
					<Row className='flex m-3'>
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
							<img
								src={`https://media2.giphy.com/media/5bkvdT11iGSbZ640ot/200w.gif?cid=82a1493b9w8pep96rpvwr4uvv7w2uk8m6ki3l247u112q2h6&rid=200w.gif&ct=g`}
								alt="Crypto Punk"
								className='showcase'
							/>
						</Col>
				...
				<section id='about' className='about'>
					...
					<Row className='flex m-3'>
						...
						<Col md={5} lg={4} xl={5} xxl={4} className='text-center'>
							<img src="https://thumbs.dreamstime.com/b/easter-egg-d-icon-gold-egg-isolated-white-background-golden-design-template-decoration-happy-easter-celebration-easter-egg-d-icon-141457840.jpg" alt="Multiple Crypto Punks" className='showcase' />
						</Col>
						<Col md={5} lg={4} xl={5} xxl={4}>
							{isError ? (
								<p>{message}</p>
